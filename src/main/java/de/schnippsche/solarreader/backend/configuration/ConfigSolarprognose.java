...
{
  private static final String SOLARPROGNOSE_URL =
    "http://www.solarprognose.de/web/solarprediction/api/v1?access-token=%s&item=%s&id=%s&type=hourly&_format=json&algorithm=%s&project=solarreader&start_epoch_time=%s&end_epoch_time=%s";
