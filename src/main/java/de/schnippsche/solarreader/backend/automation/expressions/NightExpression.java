...
public class NightExpression extends Expression
{

  public NightExpression()
  {
    super(true);
  }
  ...
  @Override public String getHtml(Map<String, String> infomap)
  {
    if (template == null)
    {
      template = new HtmlElement(SolarMain.TEMPLATES_PATH + "conditionnight.tpl");
    }
  ...
  {
    return SolarMain.languageHelper.replacePlaceholder("{rulesetup.expression.night.summary}");
  }
