<form class="needs-validation" method="post" id="id_frmsolarprognosesetup" novalidate>
  <div class="modal fade showmodal" id="id_solarprognoseedit_modal" data-bs-backdrop="static" data-bs-keyboard="false"
       tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title">{solarprognosesetup.title}</h5>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="row">
            <p>{solarprognosesetup.title.text}</p>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
              <div class="form-floating has-validation has-feedback">
                <input type="text" class="form-control" id="id_token_id" name="token" value="[token]"
                       placeholder="{solarprognosesetup.token.text}" required
                       data-bs-toggle="tooltip" data-bs-placement="bottom"
                       title="{solarprognosesetup.token.tooltip}"/>
                <label for="id_token_id">{solarprognosesetup.token.text}</label>
                <div class="invalid-feedback">{field.required.value}</div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-floating has-validation has-feedback">
                <input type="text" class="form-control" id="id_element_id" name="elementid" value="[elementid]"
                       placeholder="{solarprognosesetup.elementid.text}" required
                       data-bs-toggle="tooltip" data-bs-placement="bottom" pattern="\d+"
                       title="{solarprognosesetup.elementid.tooltip}"/>
                <label for="id_element_id">{solarprognosesetup.elementid.text}</label>
          ...
          <div class="row">
            <div class="col-md-12">
              <div id="id_solarprognosealert" class="alert alert-danger d-none">
              </div>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <input type="hidden" id="id_step" name="step" value="savesolarprognose"/>
